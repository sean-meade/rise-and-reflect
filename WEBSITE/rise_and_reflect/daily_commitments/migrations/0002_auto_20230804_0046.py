...
def create_health_areas(apps, schema_editor):
    ...
    suggested_task_for_1_eve = Tasks(health_area=user_health_area1, task="Eve task for " + HEALTH_AREAS[0][0], task_type="Evening")
    suggested_task_for_1_eve.save()
    suggested_task_for_1_morn = Tasks(health_area=user_health_area1, task="Morn task for " + HEALTH_AREAS[0][0], task_type="Morning")
    suggested_task_for_1_morn.save()
    
    user_health_area2 = UserHealthArea(health_area=HEALTH_AREAS[1][0])
    user_health_area2.save()
    suggested_task_for_2_eve = Tasks(health_area=user_health_area2, task="Eve task for " + HEALTH_AREAS[1][0], task_type="Evening")
    suggested_task_for_2_eve.save()
    suggested_task_for_2_morn = Tasks(health_area=user_health_area2, task="Morn task for " + HEALTH_AREAS[1][0], task_type="Morning")
    suggested_task_for_2_morn.save()
    
    user_health_area3 = UserHealthArea(health_area=HEALTH_AREAS[2][0])
    user_health_area3.save()

    suggested_task_for_3_eve = Tasks(health_area=user_health_area3, task="Eve task for " + HEALTH_AREAS[2][0], task_type="Evening")
    suggested_task_for_3_eve.save()
    suggested_task_for_3_morn = Tasks(health_area=user_health_area3, task="Morn task for " + HEALTH_AREAS[2][0], task_type="Morning")
    suggested_task_for_3_morn.save()

    user_health_area4 = UserHealthArea(health_area=HEALTH_AREAS[3][0])
    user_health_area4.save()
    suggested_task_for_4_eve = Tasks(health_area=user_health_area4, task="Eve task for " + HEALTH_AREAS[3][0], task_type="Evening")
